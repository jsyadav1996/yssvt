...
export const requireAdmin = requireRole(['system_admin', 'admin']);
export const requireManager = requireRole(['system_admin', 'admin', 'manager']); 
export const requireMember = requireRole(['system_admin', 'admin', 'manager', 'member']); 